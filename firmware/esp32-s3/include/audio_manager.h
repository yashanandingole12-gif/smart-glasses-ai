...
public:
    ...
    void playMelody(const uint16_t* freqs, const uint16_t* durationsMs, size_t count);
    void playSound(SoundEffect effect);
    void playPcmAudio(const int16_t* samples, size_t sampleCount, uint32_t sampleRate = I2S_SPK_SAMPLE_RATE);
